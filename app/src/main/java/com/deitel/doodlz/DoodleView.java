...
public class DoodleView extends View {
   ...
   public void setBackgroundColor(int color) {bitmap.eraseColor(color); }
   ...
   private final SensorEventListener presureListener = new SensorEventListener() {
      @Override
   ...
   private void touchMoved(MotionEvent event) {
      ...
      for (int i = 0; i < event.getPointerCount(); i++) {
         ...
         pressure = 50; // since the emulator doesn't capture pressure,
                        // I'll artificially change the pressure
                        //to see if the pressure will change the line width
         setLineWidth(pressure);
